...
- More things to change or consider, see also [the issue that handled the update "PHP 7.0 => 7.4"](https://github.com/danielmarschall/oidplus/issues/56)
	...
	* Change composer.json: change our own PHP min version
        * dev/vendor_update.sh: Change the code regarding "composer config platform.php 7.4.0"
