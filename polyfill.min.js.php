...
if (MINIFY_POLYFILL) {
	$cache_file = OIDplus::getUserDataDir("cache").'js_polyfill_'.md5(implode(',',REQUIRED_POLYFILLS)).'_'.md5($ua).'.min.js';
} else {
	$cache_file = OIDplus::getUserDataDir("cache").'js_polyfill_'.md5(implode(',',REQUIRED_POLYFILLS)).'_'.md5($ua).'.js';
}
