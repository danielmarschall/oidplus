<p>The registration of your OIDplus system has various advantages:</p><!-- please keep in sync with GDPR document -->

<ul>
	<li>The public key of your system will be published, so that users can check the integrity of your data (e.g. signed OID-WHOIS requests).</li>
	...
	<li>If your OID root is approved by ViaThinkSoft (we will manually verify that the root OID belongs to you), we will then unlock the feature to import your OIDs from oid-info.com to your OIDplus installation.</li>
