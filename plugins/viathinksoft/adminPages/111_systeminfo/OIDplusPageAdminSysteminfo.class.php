...
namespace ViaThinkSoft\OIDplus\Plugins\AdminPages\SystemInfo;
...
class OIDplusPageAdminSysteminfo extends OIDplusPagePluginAdmin {
	...
	public function gui(string $id, array &$out, bool &$handled): void {
		if ($id === 'oidplus:phpinfo') {
			...
			$out['text'] .= '		<td>'.(!$sysid ? '<i>'._L('unknown').'</i>' : '1.3.6.1.4.1.37476.2.5.2.9.4.1='.$sysid.'<span class="gray_font">, CN=OidPlus, DC=example, DC=com</span>').'</td>';
			$out['text'] .= '	</tr>';
