...
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', char(1575,1604,1605,1579,1575,1604), '1', '1');
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', char(33539,20363), '1', '1');
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', char(1055,1088,1080,1084,1077,1088), '1', '1');
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', char(50696,51228), '1', '1');
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', char(20363), '1', '1');
INSERT INTO `iri` (oid, name, longarc, well_known) VALUES ('oid:2.999', 'Beispiel', '1', '1');

-- Generator "generate_wellknown_other_sqlite" checksum 4af5a90d
