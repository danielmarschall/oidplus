...
INSERT INTO [iri] (oid, name, longarc, well_known) VALUES ('oid:2.999', CAST(CAST(N'' AS XML).value('xs:base64Binary("2KfZhNmF2KvYp9mE")', 'varbinary(MAX)') AS varchar(255)), '1', '1');
INSERT INTO [iri] (oid, name, longarc, well_known) VALUES ('oid:2.999', CAST(CAST(N'' AS XML).value('xs:base64Binary("6IyD5L6L")', 'varbinary(MAX)') AS varchar(255)), '1', '1');
INSERT INTO [iri] (oid, name, longarc, well_known) VALUES ('oid:2.999', CAST(CAST(N'' AS XML).value('xs:base64Binary("0J/RgNC40LzQtdGA")', 'varbinary(MAX)') AS varchar(255)), '1', '1');
INSERT INTO [iri] (oid, name, longarc, well_known) VALUES ('oid:2.999', CAST(CAST(N'' AS XML).value('xs:base64Binary("7JiI7KCc")', 'varbinary(MAX)') AS varchar(255)), '1', '1');
...
-- Generator "generate_wellknown_other_mssql" checksum 4af5a90d
