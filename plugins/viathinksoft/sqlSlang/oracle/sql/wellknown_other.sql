...
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', utl_raw.cast_to_varchar2(utl_encode.base64_decode(utl_raw.cast_to_raw('2KfZhNmF2KvYp9mE'))), '1', '1');
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', utl_raw.cast_to_varchar2(utl_encode.base64_decode(utl_raw.cast_to_raw('6IyD5L6L'))), '1', '1');
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', utl_raw.cast_to_varchar2(utl_encode.base64_decode(utl_raw.cast_to_raw('0J/RgNC40LzQtdGA'))), '1', '1');
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', utl_raw.cast_to_varchar2(utl_encode.base64_decode(utl_raw.cast_to_raw('7JiI7KCc'))), '1', '1');
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', utl_raw.cast_to_varchar2(utl_encode.base64_decode(utl_raw.cast_to_raw('5L6L'))), '1', '1');
INSERT INTO "IRI" (oid, name, longarc, well_known) VALUES ('oid:2.999', 'Beispiel', '1', '1');

-- Generator "generate_wellknown_other_oracle" checksum 4af5a90d
