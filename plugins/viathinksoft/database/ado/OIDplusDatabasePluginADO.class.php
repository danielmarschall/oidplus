...
class OIDplusDatabasePluginADO extends OIDplusDatabasePlugin {
	...
	public static function setupHTML(): string {
		return '<div id="DBPLUGIN_PARAMS_ADO">'.
		       ...
		       '	<br><font size="-1">'._L('Example for SQL Server').': <i>Provider=<abbr title="'._L('Alternatively').': '._L('Generation %1', 1).' = SQLOLEDB, '._L('Generation %1', 2).' = SQLNCLI11, '._L('Generation %1', 3).' = MSOLEDBSQL">MSOLEDBSQL</abbr>;Data Source=<abbr title="'._L('Alternatively').': localhost,1433">localhost\instancename</abbr>;Initial Catalog=oidplus;<abbr title="'._L('Alternatively').': User Id=...;Password=...">Integrated Security=SSPI</abbr></i>'.
